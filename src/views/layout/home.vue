<template>
  <div class="home">
    ...
    <!-- 搜索框 -->
    <van-search readonly shape="round" background="#f1f1f2" placeholder="请在此输入搜索关键词" @click="$router.push('/searchindex')" />
    ...
    <van-grid column-num="5" icon-size="40">
      <van-grid-item v-for="item in navBarList" :key="item.imgUrl"
